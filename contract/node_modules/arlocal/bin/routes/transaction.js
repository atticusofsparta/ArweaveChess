            ...
            if (bundleFormat === 'binary' && bundleVersion === '2.0.0') {
                ...
                const createTxsFromItems = (buffer) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    for (let i = 0; i < items.length; i++) {
                        const item = items[i];
                        yield txPostRoute(Object.assign(Object.assign({}, ctx), { connection: ctx.connection, dbPath: ctx.dbPath, logging: ctx.logging, network: ctx.network, request: Object.assign(Object.assign({}, ctx.request), { body: Object.assign({ id: bundle.getIdBy(i), bundledIn: data.id }, item.toJSON()) }), 
                            // @ts-ignore
                            txInBundle: true }));
                    }
                });
                if (data.data) {
                    ...
                    (() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        while (+data.data_size - 1 !== lastOffset) {
                            ...
                            lastOffset = +((_a = chunks[chunks.length - 1]) === null || _a === void 0 ? void 0 : _a.offset) || 0;
                        }
